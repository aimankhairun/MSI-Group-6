...
# --- CONFIGURATION ---
SERIAL_PORT = "COM4"  # Update with your Arduino port
BAUD_RATE = 9600
AUTHORIZED_ID = "0013070376" 
# ---------------------
...
def detect_circle(arduino):
    ...
    arduino.write(b'R')  # Trigger Arduino data stream
    ...
    print(f"Net rotation: {net_rotation:.1f} deg, Range: {rotation_range:.1f} deg")
